...
Tale scelta permette di beneficiare di molteplici vantaggi pratici. 
Tra i principali troviamo la centralizzazione dei dati, in quanto i dati gestiti dal Server vengono distribuiti al Client che li richiede, una maggiore sicurezza, specialmente la gestione da parte del Server dell'autenticazione degli utenti. Altro vantaggio particolarmente significativo risiede nella scalabilità, il modello garantisce la possibilità di aggiungere nuovi client e nuovi server senza modificare il sistema. Per tutti questi motivi, la decisione di utilizzare il modello Client-Server rappresenta la soluzione più coerente per lo sviluppo del software. 
\begin{figure}[H]
    \centering
...
Il server è stato sviluppato utilizzando il pattern architetturale 3-tier. 
