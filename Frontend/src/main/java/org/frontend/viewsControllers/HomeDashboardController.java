...
public class HomeDashboardController {
    ...
    private void aggiornaContatoriUI(List<Issue> list) {
        ...
        Platform.runLater(() -> {
            if (labelTodo != null)
                labelTodo.setText(String.valueOf(finalTodo));
            if (labelInProgress != null)
                labelInProgress.setText(String.valueOf(finalInProgress));
            if (labelDone != null)
                labelDone.setText(String.valueOf(finalDone));
        });
    }
}
